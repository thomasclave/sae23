...
<body>
    ...
    <main>
        <button onclick="location.href='./sup_bat.php'">Batiment</button>
        <button onclick="location.href='./sup_sal.php'">Salle</button>
        <button onclick="location.href='./sup_cap.php'">Capteur</button>
    </main>
